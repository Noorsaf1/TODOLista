...
var Todo = /*#__PURE__*/_createClass(function Todo(text) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var todos = [new Todo("Köpa mjölk"), new Todo("Städa rummet"), new Todo("Betala räkningar")];
  var renderTodos = function renderTodos() {
    todoList.innerHTML = "";
    todos.forEach(function (todo, index) {
      var todoItem = document.createElement("li");
      todoItem.className = "list-group-item d-flex justify-content-between align-items-center todo-item".concat(todo.done ? " done" : "");
      ...
      editButton.addEventListener("click", function () {
        var newText = prompt("Redigera uppgiften:", todo.text);
